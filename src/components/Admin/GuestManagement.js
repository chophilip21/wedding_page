  ...
  const filteredGuests = guestsList
    ...
    .sort((a, b) => {
      switch (sortOption) {
        ...
        case "Tamako":
          return a.guestSide === "Tamako" && b.guestSide !== "Tamako"
            ? -1
            : 1;
        case "Philip":
          return a.guestSide === "Philip" && b.guestSide !== "Philip"
            ? -1
            : 1;
        case "status-yes":
          ...
          <div className="w-full flex gap-2 justify-between flex-wrap border-b pb-4 mb-4">
            ...
            <div className="w-full max-w-[400px] flex gap-2 items-center justify-center">
              ...
              >
                ...
                <option value="Tamako" className="max-sm:text-[15px]">
                  Sort by Tamako&apos;s Side
                </option>
                <option value="Philip" className="max-sm:text-[15px]">
                  Sort by Philip&apos;s Side
                </option>
          ...
          <div className="w-full flex gap-2 justify-between flex-wrap border-b pb-4 mb-4">
            ...
            <div className="w-full max-w-[400px] flex gap-2 items-center justify-center">
              ...
              >
                ...
                <option value="Tamako">Sort by Tamako&apos;s Side</option>
                <option value="Philip">Sort by Philip&apos;s Side</option>
